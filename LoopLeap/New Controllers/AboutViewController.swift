...
class AboutViewController: UIViewController, UITextViewDelegate, UITextFieldDelegate
{
    ...
    func submitAboutApi() {
        ...
        if let accessToken = UserDefaults.standard.value(forKey:DefaultsIdentifier.access_token) as? String
        {
            ...
            if name.isEmpty {
                ...
                ProjectManager.sharedInstance.showAlertwithTitle(title:"", desc:"Please enter atleast message ", vc: self)
                ...
                parameters = ["name":name, "email":email, "phone":phone, "message":message]
                ...
                if ProjectManager.sharedInstance.isInternetAvailable()
                {
                    ...
                    Alamofire.request(baseURL + ApiMethods.contact, method: .post,  parameters: parameters, encoding: JSONEncoding.default, headers:headers)
